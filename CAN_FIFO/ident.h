...
//  commandes moteur
#define   MOT_SET        0x102 //|  M  |  I  |  D  |      |      |      |                 |
#define   MOT_REQ_2      0x104 //|  M  |  I  |  D  |      |      |      |                 |
#define   MOT_REQ_1      0x103 //|  M  |  I  |  D  |      |      |      |                 |
#define   MOT_CONF       0x100
#define   MOT_REGUL      0X101
#define   MOT_CAL        0x105
//  mesures moteur
#define   MOT_DAT_1      0x200
#define   MOT_DAT_2      0x201
                               //------------------------------------------------------------------------------------------
